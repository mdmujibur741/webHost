...
<template>
    <AuthenticatedLayout>
         <section class="min-h-[90vh] bg-blue-50 flex justify-center items-center m-1 p-2">
            <form @submit.prevent="submit"  class="w-full lg:w-8/12  bg-blue-50 m-3 p-4 rounded-xl shadow-md">
                
                <h3 class="text-2xl font-extrabold text-blue-900 mb-5 mt-1 text-center">Add New Page  </h3>
